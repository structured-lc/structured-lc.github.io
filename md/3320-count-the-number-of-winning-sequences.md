...
### Flashcard
Use DP with memoization: state = (position, score_diff, last_move); for each move, if different from last, update score and recurse; count sequences where Bob wins > Alice.
