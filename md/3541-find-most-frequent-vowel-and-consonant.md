...
### Flashcard
Single pass to count frequency of all 26 letters; track max frequency among vowels and separately among consonants, returning the lexicographically smallest letter in each category.
