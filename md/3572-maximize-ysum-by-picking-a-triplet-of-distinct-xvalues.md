...
### Flashcard
For each unique x-value, keep only the maximum y-value; if fewer than 3 unique x's exist, return -1; otherwise, pick the three x's with the largest corresponding y-values.
