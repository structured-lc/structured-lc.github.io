...
### Flashcard
Use DFS to traverse the tree; at each node, track the parity of the path sum and try assigning weight 1 or 2 to each edge such that the final parity matches the node's requirement.
