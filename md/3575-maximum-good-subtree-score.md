...
### Flashcard
Use tree DP with DFS; at each node, maintain a map of (bitmask of distinct values) → (max sum); merge child results ensuring no value overlap, and track the maximum score.
