...
### Flashcard
Each piston follows a sawtooth pattern with period 2×height; find the maximum cumulative sum of all piston positions across all time points within the LCM of all periods.
