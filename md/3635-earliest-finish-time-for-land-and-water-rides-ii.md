...
### Flashcard
Enumerate all (land, water) pairs and both orderings. For each, compute finish time considering wait times between rides; return minimum across all combinations.
