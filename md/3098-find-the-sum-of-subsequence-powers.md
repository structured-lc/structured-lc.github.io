...
### Flashcard
Sort array; for each subsequence of length k, power = min difference between consecutive elements; use DP or combinatorics to count subsequences by their minimum gap and sum contributions.
