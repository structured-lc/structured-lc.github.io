...
### Flashcard
Greedily delete subarrays with sum divisible by k whenever possible; use DP or recursion with memoization to track remaining array states and minimize final sum.
