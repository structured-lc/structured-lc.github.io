...
### Flashcard
Identify vertical and horizontal cut positions from rectangle boundaries; check if each rectangle fits entirely in one section and every section contains at least one.
