...
### Flashcard
Use bijective letter-to-digit mapping with two-way validation; for each position, check if pattern matches by enforcing consistent letter→digit and digit→letter assignments.
