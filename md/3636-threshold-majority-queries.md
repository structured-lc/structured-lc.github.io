...
### Flashcard
Precompute positions of each unique number. For each query [l, r], iterate through unique numbers and binary search their positions to count occurrences in range; return smallest with ≥ threshold.
