...
### Flashcard
Use DP with two states per position: keep (extend current subarray) and split (start new subarray); transition based on whether the alternating condition holds.
