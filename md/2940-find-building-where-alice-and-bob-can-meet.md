...
### Flashcard
Precompute the next greater building to the right for each building using a monotonic stack. For each query, simulate Alice and Bob's reachability by following next-greater pointers until they meet.
