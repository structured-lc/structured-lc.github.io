...
### Flashcard
Use a two-pointer sliding window approach; maintain character frequencies and expand/contract the window to find all substrings with length ≥ len(word2) containing required characters.
