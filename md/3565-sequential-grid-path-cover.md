...
### Flashcard
Use bitmask DP where the state is (current_cell, visited_bitmask); ensure that when visiting a cell labeled x, all cells labeled < x have been visited; find if a Hamiltonian path exists.
