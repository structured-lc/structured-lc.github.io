...
### Flashcard
Generate all 3-digit numbers using distinct digit indices where the last digit is even and the first digit is nonzero; store in a set to eliminate duplicates.
