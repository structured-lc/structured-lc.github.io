...
### Flashcard
Precompute safeness value (Manhattan distance to nearest thief) for each cell via multi-source BFS; use 0-1 BFS or Dijkstra to find path maximizing minimum safeness.
