...
### Flashcard
Every cell belongs to a 4-cell orbit under row/column/full symmetry—group cells into orbits, for each orbit decide flip to minimize total flips while satisfying parity constraint.
