...
### Flashcard
Sort by profit descending, greedily pick top k items; track duplicate categories, swap duplicates with next-best items if it increases unique count and score.
