...
### Flashcard
Apply standard Dijkstra's algorithm on the directed weighted graph; use a min-heap to always expand the lowest-cost node first until destination t is reached.
