...
### Flashcard
Computer 0 must be first; use DP or recursion to count valid permutations where each computer i (i > 0) is unlocked only after at least one computer j with lower complexity has been unlocked.
