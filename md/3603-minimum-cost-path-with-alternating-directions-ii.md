...
### Flashcard
Use Dijkstra's with state (row, col, last_direction) to track minimum cost reaching each cell after moving horizontally or vertically; alternate allowed directions at each step.
