...
### Flashcard
Use complementary counting: total strings of length n minus strings that cannot form "leet". A string is "good" iff it contains at least l, e×2, t; use inclusion-exclusion on character frequencies.
