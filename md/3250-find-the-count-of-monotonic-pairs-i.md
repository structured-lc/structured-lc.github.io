...
### Flashcard
DP with state (index, last_arr₁_value)—for each position, try valid arr₁[i] values (non-decreasing, arr₁[i] ≤ nums[i]), compute arr₂[i], check non-increasing constraint.
