...
### Flashcard
The XOR score of a subarray is simply the XOR of all its elements; precompute prefix XORs, then for each query [l, r], check all subarrays using prefix XOR differences.
