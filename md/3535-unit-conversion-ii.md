...
### Flashcard
Tree structure with n units and n−1 edges; for each query, find the path from unitA to unitB using DFS/BFS and multiply conversion factors (or reciprocals if traversing backward).
