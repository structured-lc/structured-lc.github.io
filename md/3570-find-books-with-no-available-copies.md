...
### Flashcard
Filter borrowing_records for rows where return_date is null; group by book_id and count borrowers; join with library_books and find books where borrower_count equals total_copies.
