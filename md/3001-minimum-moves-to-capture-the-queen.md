...
### Flashcard
Check if rook can capture in 1 move (same row/column, no bishop blocking). Check if bishop can capture in 1 move (same diagonal, no rook blocking). If both can, return 1; otherwise return 2.
