...
### Flashcard
Model sensor coverage as diamonds (Manhattan distance ≤ k). Greedily place sensors to cover uncovered cells; use a greedy or tiling approach to minimize count.
