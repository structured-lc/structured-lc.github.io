...
### Flashcard
Observe that coin denominations must satisfy forward DP constraints; use greedy or constraint-propagation to deduce valid denominations from the numWays array.
